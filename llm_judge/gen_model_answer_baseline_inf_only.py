...
def NFoxHead_forward(input_ids, model, tokenizer, NFoxHead_choices, temperature, posterior_threshold, posterior_alpha, max_steps = 512):
    ...
    for _ in range(3):
        ...
        for j in range(len(question["turns"])):
            ...
            try:
                # torch.cuda.synchronize()
                # start_time = time.time()
                output_ids, new_token, idx, total_time = NFoxHead_forward(
